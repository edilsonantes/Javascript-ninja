(function(){
    ...
    */
    ...
    var justMod2Or3 = [];
    numberObjects.forEach((item) => {
        if ((item.number % 2 === 0) || (item.number % 3 === 0)){
            justMod2Or3.push(item.number);
        }
    });
    ...
    */
    console.log( '\nOperation:' );
    var operation = numberObjects.reduce((acc, cur) => {
        return (acc + 1) * cur.number;
    }, 0);
    ...
    */
    console.log( '\nOperation 2:' );
    var operation2 = numberObjects.reduceRight((acc, cur) => {
        return (acc + 1) * cur.number;
    }, 0);
    ...
    */
    ...
    var name = ['E', 'dil', 'son'];
    console.log(name.reduce((acc, cur) => {
        return `${acc}P${cur}`;
    }, ''));
    ...
    */
    ...
    var obj = numberObjects[1];
    if(numberObjects.lastIndexOf(obj)  > -1){
        console.log("Existe um objeto { number: 2 } em numberObjects!");
    }else{
        console.log("Não existe um objeto { number: 2 } em numberObjects :(");
    }
