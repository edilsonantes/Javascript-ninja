...
*/
var nordeste = ['Bahia', 'Alagoas', 'Maranhão', 'Ceará', 'Rio Grande do Norte', 'Piauí', 'Tocanttins', 'Paraíba', 'Sergipe']
...
var flag = brasil.every(function(item){
...
flag = brasil.some(function(item){
    return item === 'Ceará';
});
